Pod::Spec.new do |s|
  ...
  s.source_files = "Externals/tidy-html5-ios/include/**/*.h"
  s.public_header_files = "Externals/tidy-html5-ios/include/**/*.h"
  s.requires_arc = false
  s.vendored_libraries = 'Externals/tidy-html5-ios/lib/*.a'
  s.prepare_command = "build_for_external=1 ./scripts/build-tidy-ios.sh"
end
