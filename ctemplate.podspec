Pod::Spec.new do |s|
  ...
  s.public_header_files = "Externals/ctemplate-ios/include/**/*.h"
  s.requires_arc = false
  s.vendored_libraries = 'Externals/ctemplate-ios/lib/*.a'
  s.prepare_command = "build_for_external=1 ./scripts/build-ctemplate-ios.sh"
end
